 ...
 */
final class Version20220304124539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE measure (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, time TIME NOT NULL, gps VARCHAR(255) NOT NULL, value INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
