...
AjaxCallFunction();
var idInter = setInterval(AjaxCallFunction, 250);//Set Interval 3s Between Each Callconst data={};
//temperature °C
temperatureMax=70
temperatureMin=-30
airTemperature=0
...
AjaxCallFunction();
var idInter = setInterval(AjaxCallFunction, 250);//Set Interval 3s Between Each Call