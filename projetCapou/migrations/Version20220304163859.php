...
final class Version20220304163859 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_valve (user_id INT NOT NULL, valve_id INT NOT NULL, INDEX IDX_D498F0AFBE80C172 (valve_id), INDEX IDX_D498F0AFA76ED395 (user_id), PRIMARY KEY(user_id, valve_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
