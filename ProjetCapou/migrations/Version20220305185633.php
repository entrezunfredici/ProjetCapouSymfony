 ...
 */
final class Version20220305185633 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE measure CHANGE date date VARCHAR(255) NOT NULL, CHANGE time time VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE measure CHANGE date date DATE NOT NULL, CHANGE time time TIME NOT NULL, CHANGE gps gps VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
